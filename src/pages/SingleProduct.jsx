...
import { formatPrice, custonFetch, generateAmountOptions } from "../utils";
...
export const loader = async ({ params }) => {
  const response = await custonFetch(`/products/${params.id}`);
...
const SingleProduct = () => {
  ...
  const addToCart = () => {
    dispatch(addItem({ product: cardProduct }));
  };
  return (
    <section>
